...
from qadence_shared import Protocol, MeasurementData

PROTOCOL_TO_MODULE = {
    "tomography": ("qadence_measurements.tomography", "Tomography"),
    "shadow": ("qadence_measurements.shadow", "ShadowManager"),
    "robust_shadow": ("qadence_measurements.robust_shadow", "RobustShadowManager"),
}
