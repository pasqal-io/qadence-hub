This tutorial shows how to apply `qadenc-model` for solving a basic quantum
...
Qadence-model provides the `QNN` convenience constructor to build a quantum neural network.
...
Qadence-model offers some convenience functions to implement this training loop with advanced logging and metrics track features.
