In this tutorial we will show how to use Qadence-Model to solve a basic classification task using a hybrid quantum-classical model composed of a QNN and classical layers.
