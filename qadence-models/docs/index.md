...
Qadence Models is a collection of features to enhance Qadence quantum machine learning features
...
`qadence-models` is available on PyPi through `pip`.

```bash
pip install qadence-models
``` -->
