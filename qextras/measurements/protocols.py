...
from qextras.measurements.abstract import MeasurementManager
from qextras.protocols import Protocol
from qextras.types import MeasurementData

PROTOCOL_TO_MODULE = {
    "tomography": ("qextras.measurements.tomography", "Tomography"),
    "shadow": ("qextras.measurements.shadow", "ShadowManager"),
    "robust_shadow": ("qextras.measurements.robust_shadow", "RobustShadowManager"),
}
